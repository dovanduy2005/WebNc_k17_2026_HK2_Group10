<?php $__env->startSection('title', 'Đăng nhập / Đăng ký - AutoLux'); ?>
...
<div class="min-h-screen bg-background flex" x-data="{ mode: 'login', showPassword: false }">
    ...
    <div class="flex-1 flex items-center justify-center p-8 pt-32 lg:pt-8">
        <div class="w-full max-w-md">
            <!-- Logo -->
            <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-3 mb-10">
            ...
            <!-- Login Form -->
            <form x-show="mode === 'login'" action="<?php echo e(url('/login')); ?>" method="POST" class="space-y-5">
                <?php echo csrf_field(); ?>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="email@example.com" class="w-full pl-12 h-12 bg-secondary border border-border rounded-xl px-4 focus:outline-none focus:ring-1 focus:ring-primary transition-all">
                    </div>
                </div>
            ...
            <!-- Register Form -->
            <form x-show="mode === 'register'" action="<?php echo e(url('/register')); ?>" method="POST" class="space-y-5">
                <?php echo csrf_field(); ?>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" required placeholder="Nguyễn Văn A" class="w-full pl-12 h-12 bg-secondary border border-border rounded-xl px-4 focus:outline-none focus:ring-1 focus:ring-primary transition-all">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DUY\Downloads\WebNC_K17_2026_HK2_Nhom10.-main\WebNC_K17_2026_HK2_Nhom10.-main\resources\views/auth.blade.php ENDPATH**/ ?>