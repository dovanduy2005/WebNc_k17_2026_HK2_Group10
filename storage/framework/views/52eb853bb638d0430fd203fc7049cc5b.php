<?php $__env->startSection('title', 'Thông tin cá nhân - AutoLux'); ?>
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1 space-y-6 animate-slide-up" style="animation-delay: 100ms">
                    <div class="card-luxury p-8 flex flex-col items-center text-center">
                        ...
                        <h2 class="text-xl font-bold mb-1"><?php echo e($user->name); ?></h2>
                        <p class="text-sm text-muted-foreground mb-4"><?php echo e($user->email); ?></p>
                        <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full <?php echo e($user->role === 'admin' ? 'bg-amber-500/10 text-amber-500 border-amber-500/20' : 'bg-primary/10 text-primary border-primary/20'); ?> text-xs font-medium border">
                    ...
                    <div class="card-luxury p-6 space-y-4">
                        ...
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="font-medium text-foreground"><?php echo e($stats['contracts_count']); ?></span>
                        </div>
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-muted-foreground">Xe yêu thích</span>
                            <span class="font-medium text-foreground"><?php echo e($stats['favorites_count']); ?></span>
                        </div>
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-muted-foreground">Lịch hẹn</span>
                            <span class="font-medium text-foreground"><?php echo e($stats['bookings_count']); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-2 animate-slide-up" style="animation-delay: 200ms">
                    <div class="card-luxury p-8">
                        <form action="<?php echo e(url('/profile')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="grid md:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        ...
                                        <input type="text" name="name" value="<?php echo e(old('name', $user->name)); ?>" required placeholder="Nhập họ tên" class="w-full h-12 bg-secondary border border-border rounded-xl px-4 focus:outline-none focus:ring-1 focus:ring-primary transition-all">
                                    </div>
                                    <div class="space-y-2">
                                        <label class="text-sm font-medium text-muted-foreground">Email</label>
                                        <input type="email" value="<?php echo e($user->email); ?>" disabled class="w-full h-12 bg-background border border-border rounded-xl px-4 text-muted-foreground cursor-not-allowed">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input type="tel" name="phone" value="<?php echo e(old('phone', $user->phone)); ?>" placeholder="Nhập số điện thoại" class="w-full h-12 bg-secondary border border-border rounded-xl px-4 focus:outline-none focus:ring-1 focus:ring-primary transition-all">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea name="address" rows="4" placeholder="Nhập địa chỉ chi tiết (Số nhà, đường, phường, quận, thành phố...)" class="w-full bg-secondary border border-border rounded-xl p-4 focus:outline-none focus:ring-1 focus:ring-primary transition-all"><?php echo e(old('address', $user->address)); ?></textarea>
                                </div>
                            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="card-luxury p-6 flex flex-col md:flex-row gap-6 relative overflow-hidden group">
                        ...
                        <div class="w-full md:w-48 aspect-video rounded-xl overflow-hidden flex-shrink-0">
                            ...
                            ?>
                            <img src="<?php echo e($imageUrl); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        </div>
                        ...
                        <div class="flex-grow space-y-4">
                            <div class="flex items-start justify-between">
                                <div>
                                    <span class="text-xs font-bold text-primary uppercase tracking-wider mb-1 block">#<?php echo e($contract->contract_number); ?></span>
                                    <h3 class="text-xl font-bold"><?php echo e($contract->car->name); ?></h3>
                                    <p class="text-muted-foreground text-sm"><?php echo e($contract->car->year); ?> • <?php echo e($contract->car->brand->name ?? 'Xe'); ?></p>
                                </div>
                                <?php
                                    $statusClasses = [
                                ...
                                ?>
                                <span class="px-3 py-1 rounded-full text-xs font-bold <?php echo e($statusClasses[$contract->status] ?? 'bg-secondary text-muted-foreground'); ?>">
                            ...
                            <div class="grid sm:grid-cols-2 gap-4 pt-2 border-t border-border/50">
                                <div class="space-y-1">
                                    ...
                                    <p class="font-medium"><?php echo e($contract->created_at->format('d/m/Y')); ?></p>
                                </div>
                                <div class="space-y-1">
                                    <span class="text-xs text-muted-foreground font-medium uppercase">Tiền cọc</span>
                                    <p class="font-bold text-primary"><?php echo e(number_format($contract->deposit_amount)); ?> đ</p>
                                </div>
                                <?php if($contract->inspection_date): ?>
                                <div class="space-y-1">
                                    ...
                                    <p class="font-medium text-blue-500"><?php echo e(\Carbon\Carbon::parse($contract->inspection_date)->format('H:i - d/m/Y')); ?></p>
                                </div>
                                <?php endif; ?>
                                <?php if($contract->handover_date): ?>
                                <div class="space-y-1">
                                    <span class="text-xs text-muted-foreground font-medium uppercase flex items-center gap-1">
                                    ...
                                    <p class="font-medium text-green-500"><?php echo e(\Carbon\Carbon::parse($contract->handover_date)->format('H:i - d/m/Y')); ?></p>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DUY\Downloads\WebNC_K17_2026_HK2_Nhom10.-main\WebNC_K17_2026_HK2_Nhom10.-main\resources\views/profile/show.blade.php ENDPATH**/ ?>