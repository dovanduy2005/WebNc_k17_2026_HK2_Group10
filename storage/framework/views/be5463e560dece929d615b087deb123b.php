<?php $__env->startSection('title', 'Về chúng tôi - AutoLux'); ?>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="text-center px-4">
                        ...
                        <p class="text-3xl md:text-4xl font-bold text-gradient-accent mb-2"><?php echo e($stat['value']); ?></p>
                        <p class="text-muted-foreground"><?php echo e($stat['label']); ?></p>
                    </div>
                ...
                <?php $__currentLoopData = $values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card-luxury rounded-2xl p-8 transition-all duration-500 hover:-translate-y-2">
                        <div class="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mb-6 text-primary">
                            ...
                            <?php elseif($value['icon'] == 'thumbs-up'): ?>
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 10v12"/><path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2h0a3.13 3.13 0 0 1 3 3.88Z"/></svg>
                            <?php endif; ?>
                        </div>
                        <h3 class="text-xl font-semibold mb-3"><?php echo e($value['title']); ?></h3>
                        <p class="text-muted-foreground leading-relaxed"><?php echo e($value['description']); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </section>
                            ...
                            <?php $__currentLoopData = $reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex items-center gap-3">
                                    <div class="w-6 h-6 rounded-full bg-primary flex items-center justify-center flex-shrink-0">
                                        <span class="text-primary-foreground text-sm font-bold"><?php echo e($index + 1); ?></span>
                                    </div>
                                    <span class="text-foreground/90"><?php echo e($reason); ?></span>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DUY\Downloads\WebNC_K17_2026_HK2_Nhom10.-main\WebNC_K17_2026_HK2_Nhom10.-main\resources\views/about.blade.php ENDPATH**/ ?>