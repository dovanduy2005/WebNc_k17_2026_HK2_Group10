<?php $__env->startSection('title', 'Dashboard - AutoLux Admin'); ?>

<?php $__env->startSection('content'); ?>
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-3xl font-bold">Dashboard</h1>
        <p class="text-muted-foreground"><?php echo e(date('d/m/Y')); ?></p>
    </div>
        ...
        <div class="p-6 bg-card rounded-xl border shadow-sm">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold"><?php echo e($totalCars); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 bg-card rounded-xl border shadow-sm">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold"><?php echo e($totalUsers); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 bg-card rounded-xl border shadow-sm">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold"><?php echo e($totalContracts); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 bg-card rounded-xl border shadow-sm">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold"><?php echo e(number_format($revenue)); ?> đ</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y">
                        ...
                        <tr>
                            <td class="py-3 font-medium"><?php echo e($contract->contract_number); ?></td>
                            <td class="py-3"><?php echo e($contract->user->name); ?></td>
                            <td class="py-3"><?php echo e($contract->car->name); ?></td>
                            <td class="py-3"><?php echo e(number_format($contract->deposit_amount)); ?> đ</td>
                            <td class="py-3"><?php echo e($contract->created_at->format('d/m/Y')); ?></td>
                            <td class="py-3">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DUY\Downloads\WebNC_K17_2026_HK2_Nhom10.-main\WebNC_K17_2026_HK2_Nhom10.-main\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>