...
<div class="group relative card-luxury rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-2 block">
    ...
    <div class="absolute top-4 left-4 z-20">
        <?php if(auth()->guard()->check()): ?>
            <form action="<?php echo e(route('favorites.toggle', $id)); ?>" method="POST" x-data="{ isFavorite: <?php echo e($isFavorite ? 'true' : 'false'); ?> }">
                <?php echo csrf_field(); ?>
                <button type="submit" 
                        @click.prevent="isFavorite = !isFavorite; fetch('<?php echo e(route('favorites.toggle', $id)); ?>', { method: 'POST', headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' } })"
        ...
        <?php else: ?>
            <a href="<?php echo e(url('/auth')); ?>" class="w-10 h-10 rounded-full bg-background/50 backdrop-blur-md flex items-center justify-center text-foreground/70 hover:bg-background/80 transition-all">
    ...
    <a href="<?php echo e(url('/cars/' . $id)); ?>" class="block p-0">
        <!-- Image -->
        <div class="relative aspect-[16/10] overflow-hidden">
            <img src="<?php echo e($image); ?>" alt="<?php echo e($name); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
        ...
        <div class="p-6">
            <div class="mb-4">
                ...
                <p class="text-sm text-muted-foreground mt-1"><?php echo e($type); ?> • <?php echo e($year); ?></p>
            </div>
            ...
            <div class="flex items-center gap-4 mb-5 pb-5 border-b border-border">
                <div class="flex items-center gap-1.5 text-muted-foreground">
                    ...
                    <span class="text-xs"><?php echo e($power); ?></span>
                </div>
                <div class="flex items-center gap-1.5 text-muted-foreground">
                    ...
                    <span class="text-xs"><?php echo e($fuel); ?></span>
                </div>
                <div class="flex items-center gap-1.5 text-muted-foreground">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    <span class="text-xs"><?php echo e($seats); ?> chỗ</span>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl font-bold text-primary"><?php echo e(\App\Helpers\CarHelper::formatPrice($price)); ?></p>
                </div>
...
<?php /**PATH C:\Users\DUY\Downloads\WebNC_K17_2026_HK2_Nhom10.-main\WebNC_K17_2026_HK2_Nhom10.-main\resources\views/components/car-card.blade.php ENDPATH**/ ?>