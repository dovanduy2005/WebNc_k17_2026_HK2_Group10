<?php $__env->startSection('title', 'Quản lý đơn hàng - AutoLux Admin'); ?>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y">
                    ...
                    <tr class="hover:bg-muted/50 transition-colors">
                        <td class="px-6 py-4 font-bold"><?php echo e($contract->contract_number); ?></td>
                        <td class="px-6 py-4">
                            <p class="font-medium"><?php echo e($contract->user->name); ?></p>
                            <p class="text-xs text-muted-foreground"><?php echo e($contract->phone); ?></p>
                        </td>
                        <td class="px-6 py-4"><?php echo e($contract->car->name); ?></td>
                        <td class="px-6 py-4 font-bold text-primary"><?php echo e(number_format($contract->deposit_amount)); ?> đ</td>
                        <td class="px-6 py-4"><?php echo e($contract->created_at->format('d/m/Y H:i')); ?></td>
                        <td class="px-6 py-4">
                            <?php
                                $statusClasses = [
                            ...
                            ?>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($statusClasses[$contract->status] ?? 'bg-gray-100 text-gray-800'); ?>">
                                <?php echo e($statusLabels[$contract->status] ?? $contract->status); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 text-right">
                            <a href="<?php echo e(route('admin.contracts.show', $contract)); ?>" class="text-primary font-bold hover:underline">Chi tiết</a>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DUY\Downloads\WebNC_K17_2026_HK2_Nhom10.-main\WebNC_K17_2026_HK2_Nhom10.-main\resources\views/admin/contracts/index.blade.php ENDPATH**/ ?>