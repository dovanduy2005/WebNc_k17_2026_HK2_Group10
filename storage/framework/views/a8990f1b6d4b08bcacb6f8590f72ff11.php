<?php $__env->startSection('title', 'Quản lý xe - AutoLux Admin'); ?>

<?php $__env->startSection('content'); ?>
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-3xl font-bold">Danh sách xe</h1>
        <a href="<?php echo e(route('admin.cars.create')); ?>" class="flex items-center gap-2 bg-primary text-primary-foreground px-4 py-2 rounded-xl font-bold hover:shadow-lg transition-all">
                    ...
                    <tr class="hover:bg-muted/50 transition-colors">
                        <td class="px-6 py-4">
                            <div class="w-20 h-14 rounded-lg bg-muted overflow-hidden">
                                <?php if($car->image): ?>
                                    <img src="<?php echo e(Storage::url($car->image)); ?>" alt="" class="w-full h-full object-cover">
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <p class="font-bold"><?php echo e($car->name); ?></p>
                            <p class="text-xs text-muted-foreground"><?php echo e($car->year); ?> • <?php echo e($car->engine ?? 'N/A'); ?></p>
                        </td>
                        <td class="px-6 py-4"><?php echo e($car->brand->name ?? '-'); ?></td>
                        <td class="px-6 py-4 text-primary font-bold"><?php echo e(number_format($car->price)); ?> đ</td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($car->status === 'available' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                <?php echo e($car->status === 'available' ? 'Đang bán' : 'Đã bán'); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo e(route('admin.cars.edit', $car)); ?>" class="p-2 hover:bg-muted rounded-lg text-blue-600 transition-colors">
                                ...
                                <form action="<?php echo e(route('admin.cars.destroy', $car)); ?>" method="POST" onsubmit="return confirm('Bạn có chắc muốn xóa xe này?')">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DUY\Downloads\WebNC_K17_2026_HK2_Nhom10.-main\WebNC_K17_2026_HK2_Nhom10.-main\resources\views/admin/cars/index.blade.php ENDPATH**/ ?>