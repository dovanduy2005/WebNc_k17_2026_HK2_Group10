    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div class="space-y-6">
                ...
                <ul class="space-y-3">
                    <li><a href="<?php echo e(url('/')); ?>" class="text-muted-foreground hover:text-primary transition-colors">Trang chủ</a></li>
                    <li><a href="<?php echo e(url('/cars')); ?>" class="text-muted-foreground hover:text-primary transition-colors">Danh sách xe</a></li>
                    <li><a href="<?php echo e(url('/about')); ?>" class="text-muted-foreground hover:text-primary transition-colors">Giới thiệu</a></li>
                    <li><a href="<?php echo e(url('/contact')); ?>" class="text-muted-foreground hover:text-primary transition-colors">Liên hệ</a></li>
                </ul>
            </div>
        ...
        <div class="pt-8 border-t border-border/50 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
            <p>© <?php echo e(date('Y')); ?> AutoLux Luxury Motors. Tất cả quyền được bảo lưu.</p>
...
<?php /**PATH C:\Users\DUY\Downloads\WebNC_K17_2026_HK2_Nhom10.-main\WebNC_K17_2026_HK2_Nhom10.-main\resources\views/components/footer.blade.php ENDPATH**/ ?>