<header class="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/50">
        ...
        <div class="flex items-center justify-between h-20">
            ...
            <nav class="hidden lg:flex items-center gap-8">
                ...
                <?php $__currentLoopData = $navLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(url($link['path'])); ?>" 
                       class="relative text-sm font-medium transition-colors duration-300 hover:text-primary <?php echo e(request()->is(ltrim($link['path'], '/')) || (request()->is('/') && $link['path'] == '/') ? 'text-primary' : 'text-muted-foreground'); ?>">
                        <?php echo e($link['name']); ?>

                        <?php if(request()->is(ltrim($link['path'], '/')) || (request()->is('/') && $link['path'] == '/')): ?>
            ...
            <div class="hidden lg:flex items-center gap-4">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-card border border-border rounded-xl shadow-lg py-2 z-50">
                            <a href="<?php echo e(route('profile')); ?>" class="flex items-center gap-2 px-4 py-2 text-sm hover:bg-secondary transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                                Hồ sơ của tôi
                            </a>
                            <a href="<?php echo e(route('favorites')); ?>" class="flex items-center gap-2 px-4 py-2 text-sm hover:bg-secondary transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>
                                Xe yêu thích
                            </a>
                            <a href="<?php echo e(route('contracts')); ?>" class="flex items-center gap-2 px-4 py-2 text-sm hover:bg-secondary transition-colors">
                ...
                <?php else: ?>
                    <a href="<?php echo e(url('/auth')); ?>" class="bg-primary text-primary-foreground px-6 py-2 rounded-xl font-medium btn-primary-glow transition-all hover:scale-105 active:scale-95">
                        Đăng nhập
                    </a>
                <?php endif; ?>
            </div>
    ...
    <div x-data="{ open: false }" 
        ...
        <nav class="container mx-auto px-4 py-6 flex flex-col gap-4">
            <?php $__currentLoopData = $navLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(url($link['path'])); ?>" 
                   class="text-lg font-medium py-2 px-4 rounded-lg transition-colors <?php echo e(request()->is(ltrim($link['path'], '/')) || (request()->is('/') && $link['path'] == '/') ? 'bg-primary text-primary-foreground' : 'text-foreground hover:bg-secondary'); ?>">
                    <?php echo e($link['name']); ?>
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('profile')); ?>" class="text-lg font-medium py-2 px-4 rounded-lg hover:bg-secondary">Cá Nhân</a>
                <a href="<?php echo e(route('favorites')); ?>" class="text-lg font-medium py-2 px-4 rounded-lg hover:bg-secondary">Xe yêu thích</a>
                <a href="<?php echo e(route('contracts')); ?>" class="text-lg font-medium py-2 px-4 rounded-lg hover:bg-secondary">Hợp đồng của tôi</a>
                <form method="POST" action="<?php echo e(route('logout')); ?>">
                    <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
                <div class="pt-4 border-t border-border">
                    <a href="<?php echo e(url('/auth')); ?>" class="block w-full text-center bg-primary text-primary-foreground py-3 rounded-xl font-medium btn-primary-glow">
                        Đăng nhập
                    </a>
                </div>
            <?php endif; ?>
...
<?php /**PATH C:\Users\DUY\Downloads\WebNC_K17_2026_HK2_Nhom10.-main\WebNC_K17_2026_HK2_Nhom10.-main\resources\views/components/header.blade.php ENDPATH**/ ?>