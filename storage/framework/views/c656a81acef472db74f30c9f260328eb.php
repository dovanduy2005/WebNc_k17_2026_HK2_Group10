    ...
    <div class="w-full max-w-md p-6">
        <div class="bg-card border rounded-2xl shadow-xl overflow-hidden p-8">
            ...
            <form action="<?php echo e(route('admin.login.submit')); ?>" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="admin@example.com" class="w-full pl-12 h-12 bg-secondary border border-border rounded-xl px-4 focus:outline-none focus:ring-1 focus:ring-primary transition-all">
                    </div>
                </div>
            ...
            <div class="mt-8 text-center">
                 <a href="<?php echo e(url('/')); ?>" class="text-sm text-muted-foreground hover:text-foreground">← Quay lại trang chủ</a>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\DUY\Downloads\WebNC_K17_2026_HK2_Nhom10.-main\WebNC_K17_2026_HK2_Nhom10.-main\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>