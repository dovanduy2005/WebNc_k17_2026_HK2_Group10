    ...
    <div class="min-h-screen flex bg-muted/40">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-background border-r transition-transform duration-300 lg:static lg:translate-x-0"
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="{{ route('admin.profile') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all {{ request()->routeIs('admin.profile') ? 'bg-primary text-primary-foreground shadow-md' : 'hover:bg-muted text-muted-foreground hover:text-foreground' }}">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header class="h-16 bg-background border-b flex items-center justify-between px-6 lg:justify-end">
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.profile') }}" class="flex items-center gap-4 hover:opacity-80 transition-opacity">
